        ...
        try {
            ...
            const columns = [
                ...
                },
                {
                    ...
                    <div style="display:flex; gap:10px;">
                        <button class="btn-edit-client" data-id="${row.id}" style="color:var(--primary); font-weight:600; border:none; background:none; cursor:pointer;">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="btn-delete-client" data-id="${row.id}" style="color:#EF4444; font-weight:600; border:none; background:none; cursor:pointer;">
